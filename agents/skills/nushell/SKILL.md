...
- CI workflow steps run Nushell via `shell: nu {0}` with `hustcer/setup-nu`. See `.github/workflows/update-overlays.yaml` for the established style.
...
- Standalone scripts live alongside their consumer, e.g. `.claude/skills/toolbelt/generate.nu`.
