...
4. Keep a useEffect only when no pattern from the guidelines replaces it — it is an escape hatch for synchronising with external systems — and add a comment saying why, linking the relevant section.
